...
import { commitLifecycleForInstance } from './lifecycle';
import { beginRenderTracking, clearRenderTracking } from './scope';
...
import { setDevValue } from '../diagnostics/dev-namespace';
