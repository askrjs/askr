...
import { configureBoundaryRangeHost } from './range-adoption';
import { syncControlBoundaryScopeDom } from './range-sync';
...
} from './range-placement';
export { removeBoundaryRange } from './range-cleanup';
export { syncControlBoundaryScopeDom } from './range-sync';
import {
  getRangeNodes,
  insertRangeBefore,
  rangeContains,
