import { clearChildScopeHost } from '../ownership/scope-host';
import { joinChildScopePreparation } from '../../runtime/ownership/child-scope';
import type { ChildScope } from '../../runtime';
import { syncControlBoundaryScopeDom } from '../control/boundaries';
import { retireNodeSubtree } from '../ownership/cleanup';
import { getRangeNodes } from '../ownership/ranges';
import {
