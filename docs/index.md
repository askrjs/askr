...
Askr documentation is organized around how people learn, build, and scale with the platform, not around package boundaries.
...
- [SSR](./guides/ssr.md)
- [SSR Events](./guides/ssr-events.md)
- [SSG](./guides/ssg.md)
...
- [Spec Guarantees](./reference/spec-guarantees.md)

## Go Deeper

- [Event Delegation](./advanced/event-delegation.md)
- [Selective Hydration](./advanced/selective-hydration.md)
- [For Primitive Design](./internals/for-primitive-design.md)
- [Foundations: Pit of Success](./internals/foundations-pit-of-success.md)
- [Foundations: Audit Report](./internals/foundations-audit-report.md)
- [Router Manifest](./internals/router-manifest.md)
...
- [Navigation Promotion Roadmap](./roadmap/navigation-promotion.md)

## Contribute

- [Docs Style Guide](./contributing/docs-style-guide.md)
- [Testing Guide](./contributing/testing.md)
- [Migration Reference](./contributing/migration-reference.md)

## Notes

- Package-local `docs/` folders are consolidated into this single platform docs hub.
- New docs should be placed by reader intent and topic, not by package name.
