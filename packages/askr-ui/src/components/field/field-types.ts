...
import type { InputInputProps } from '../input';
import type { RadioGroupProps } from '../radio-group';
import type { SelectTriggerProps } from '../select';
import type { SwitchButtonProps } from '../switch';
...
export type FieldInputProps = Omit<
  InputInputProps,
  'id' | 'required' | 'disabled' | 'aria-describedby' | 'aria-invalid' | 'aria-required' | 'aria-disabled'
> & {
  fieldId?: string;
  invalid?: boolean;
  required?: boolean;
...
export type FieldSelectTriggerProps = Omit<
  SelectTriggerProps,
  'id' | 'disabled' | 'aria-describedby' | 'aria-invalid' | 'aria-required' | 'aria-disabled'
> & {
  fieldId?: string;
  invalid?: boolean;
  required?: boolean;
...
export type FieldCheckboxProps = Omit<
  CheckboxInputProps,
  'id' | 'disabled' | 'required' | 'aria-describedby' | 'aria-invalid' | 'aria-required' | 'aria-disabled'
> & {
  fieldId?: string;
  invalid?: boolean;
  required?: boolean;
